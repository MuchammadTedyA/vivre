            ...
            <div class="col-sm-8">
                ...
                <form class="ma">
                    ...
                    <div class="form-group margin">
                      ...
                      <textarea name="deskripsiProduk" type="area" class="form-control" id="formGroupExampleInput2" placeholder="" value="{{ $produk->deskrisi_produk }}"></textarea>
                    </div>
                    <div class="form-group margin">
                        ...
                        <select class="form-select" aria-label="Default select example" name="kategoriProduk" required>
                            <option selected disabled value="{{ $produk->kategori_produk }}">--Pilih Kategori--</option>
