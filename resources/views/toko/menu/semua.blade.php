    ...
    <table class="table table-striped text-center">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="text-align: center"><a class="btn btn-danger" href="hapusProduk/{{$item->id_produk}}" style="width: 85px">Hapus</a> &nbsp; <a class="btn btn-warning" href="tokoSaya/editProduk/{{$item->id_produk}}"style="width: 85px">Ubah</a></td>
        </tr>
          @endforeach
